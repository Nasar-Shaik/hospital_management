/**
 * What the ambulance module does when two patients are merged: move its references onto the
...
export const ambulanceConsumers: ModuleConsumers = {
  events: {
    [EVENTS.PATIENTS_MERGED]: onPatientsMerged("ambulance", repo.repointPatient),
  },
};
