/**
 * What the mar module does when two patients are merged: move its references onto the
...
export const marConsumers: ModuleConsumers = {
  events: {
    [EVENTS.PATIENTS_MERGED]: onPatientsMerged("mar", repo.repointPatient),
  },
};
