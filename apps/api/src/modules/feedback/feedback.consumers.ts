/**
 * What the feedback module does when two patients are merged: move its references onto the
...
export const feedbackConsumers: ModuleConsumers = {
  events: {
    [EVENTS.PATIENTS_MERGED]: onPatientsMerged("feedback", repo.repointPatient),
  },
};
