/**
 * What the insurance module does when two patients are merged: move its references onto the
...
export const insuranceConsumers: ModuleConsumers = {
  events: {
    [EVENTS.PATIENTS_MERGED]: onPatientsMerged("insurance", repo.repointPatient),
  },
};
