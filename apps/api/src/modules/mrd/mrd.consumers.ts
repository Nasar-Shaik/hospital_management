/**
 * What the mrd module does when two patients are merged: move its references onto the
...
export const mrdConsumers: ModuleConsumers = {
  events: {
    [EVENTS.PATIENTS_MERGED]: onPatientsMerged("mrd", repo.repointPatient),
  },
};
