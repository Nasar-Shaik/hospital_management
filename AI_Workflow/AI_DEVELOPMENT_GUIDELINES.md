...
Operating manual for AI agents (Claude, GPT, and successors) acting as engineers on this project. `PROJECT_CONSTITUTION.md` is the authority; this document is the *how*.
