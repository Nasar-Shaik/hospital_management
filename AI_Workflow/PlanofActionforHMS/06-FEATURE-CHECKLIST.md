...
## Emergency & Critical Care _(flag-gated, P3)_
...
## Specialty Services _(flag-gated, P3/P5)_
...
## Support Departments _(flag-gated, P3)_
...
> **Scope note:** this verification asserts _blueprint completeness_ (every feature is specified and traceable), **not build status**. Build status lives in [00-PROGRESS-TRACKER.md](./00-PROGRESS-TRACKER.md) and is the single source of truth for "what is actually implemented."
