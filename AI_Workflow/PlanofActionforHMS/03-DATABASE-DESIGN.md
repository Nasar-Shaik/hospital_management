...
patients 1───* visits ──* appointments ──1 doctors
patients 1───* admissions 1───* bedAllocations *───1 beds
patients 1───* emrRecords 1───* soapNotes / diagnoses / procedures
emrRecords ──* orders ──1 labOrders / radiologyOrders
labOrders 1───* samples 1───* labResults
consultations 1───1 prescriptions 1───* prescriptionItems ──1 medicines
prescriptionItems ──* medicationAdministration (MAR)
visits/admissions 1───* bills 1───* billItems ; bills 1───* payments
