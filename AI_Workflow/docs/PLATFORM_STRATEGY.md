...
> **Rule P1: platform-candidate modules must contain zero healthcare vocabulary.** The notification module notifies "recipients about events," not "patients about appointments." HMS-specific wording, types, and logic live in HMS modules that _use_ platform modules. This costs nothing now and is unbuildable retroactively.
...
| **RBAC & Permissions**                                                          | A4                | ✅ Generic engine                                                                                                                                         | Permission _catalog_ is per-product data                      |
...
| **HR/Payroll**                                                                  | F7                | ⚠️ Semi — HR is also a _product_ (HRMS)                                                                                                                   | Build clean enough to seed the HRMS product later             |
