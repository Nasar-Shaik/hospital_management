...
| **WEB-02** | Wrong host                  | —           | Browse a slug that does not exist.                            | _"This address does not belong to any hospital"_ — the URL, not the password.                                                                                             |                                                                                                               |
| **WEB-03** | Ward page                   | Nurse A     | Open `/ward`.                                                 | Admitted patients for branch A with beds.                                                                                                                                 |                                                                                                               |
| **WEB-04** | Ward identity               | Nurse A     | Read rows.                                                    | **Name + UHID on every row.**                                                                                                                                             | → §9.                                                                                                         |
