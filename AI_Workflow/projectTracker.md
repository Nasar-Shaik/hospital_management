...
|                        |                                                                                                                                                                                                                                                                                                                                                                                                                            |
| ---------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Branch**             | `feature/0.1` — **23 commits unpushed**, HEAD `1e88229`, tree clean                                                                                                                                                                                                                                                                                                                                                        |
...
| **Gates**              | `format` · `lint` 18/18 · `typecheck` 18/18 · `unit` · `openapi` · `contract` · `client` · `build` 11/11 · `boundaries` — green. **`integration` is green on re-run and in isolation, not on every full run** — 4 runs on 2026-08-17 failed 4 disjoint sets, every failure a 20s timeout and none an assertion. Raised as **T3**; see `TESTING.md` §9.                                                                     |
