...
|                        |                                                                                                                                                                                                                                                            |
| ---------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Branch**             | `feature/0.1` — **16 commits unpushed**, HEAD `fe6f6e7`                                                                                                                                                                                                    |
...
| **Open defects**       | **4 fixed 2026-08-16** (D1 vitals scope · D2 reception TZ · D3 bed-day TZ · D6 migration preflight). **2 reclassified** as deliberate design (D4, D5). **1 open** — D7, a product decision. T2 partially controlled. See `docs/RISK_REGISTER.md` §0.       |
