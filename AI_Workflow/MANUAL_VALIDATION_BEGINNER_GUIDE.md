...
| **WEB-02** | —               | Browse a slug that does not exist                            | _"This address does not belong to any hospital"_ — **the URL, not the password**                                                                                              | Try `http://nosuchhospital.localhost:3000`. The message must blame the address.                            |
| **WEB-03** | Nurse A         | Open `/ward`                                                 | Admitted patients for **branch A**, with beds                                                                                                                                 | Expect ~42 rows                                                                                            |
| **WEB-04** | Nurse A         | Read rows                                                    | **Name + UHID on every row**                                                                                                                                                  | Scroll the whole list. One blank identity is a safety defect.                                              |
